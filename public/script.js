...
function appendMessage(msg, doScroll = true) {
  ...
  const actions = isMine ? `
    <div class="msg-actions">
      <button class="msg-action-btn" onclick="startEdit('${msg.id}', '${currentChatUserId}')" title="Edit" aria-label="Edit message">
      ...
      <button class="msg-action-btn delete-btn" onclick="confirmDelete('${msg.id}', '${currentChatUserId}')" title="Delete" aria-label="Delete message">
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
